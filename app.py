...
# ---------------------- MENU SIDEBAR ----------------------
with st.sidebar:
    st.title("🎮 Roblox Dashboard UI")

    menu = st.radio(
        "Menu Navigasi",
        ["Dashboard", "Analisis PCA", "Line Chart", "Ranking", "About"]
    )
...
if menu == "Dashboard":
    ...
    st.markdown("### Visualisasi interaktif menggunakan K-Means, PCA, Line Chart, dan Ranking ✨")
...
# ---------------------- MENU: LINE CHART ----------------------
    ...
    st.title("📈 Trend Line Chart Antar Cluster")
...
# ---------------------- MENU: ABOUT ----------------------
    ...
    st.markdown("""
    ### **Roblox Machine Learning Dashboard**  
    Dibuat menggunakan:
    - Streamlit  
    - K-Means Clustering  
